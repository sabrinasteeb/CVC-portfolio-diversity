...
xtnbreg patent_count diversity_ln_L1 absorptive_capacity_L1 geo_diversity_L1 sales_ln_L1 current_ratio_L1 age_L1 cvc_experience_ln_L1 acquisitions_L1 jointventures_L1 portfolio_size_L1 i.fyear,fe  irr
...
*FULL MODEL
xtnbreg patent_count diversity_ln_L1 absorptive_capacity_L1 geo_diversity_L1 c.absorptive_capacity_L1#c.diversity_ln_L1  c.geo_diversity_L1#c.diversity_ln_L1 sales_ln_L1 current_ratio_L1 age_L1  cvc_experience_ln_L1 acquisitions_L1 jointventures_L1 portfolio_size_L1  i.fyear,fe  irr
...
*quietly margins, at(diversity_ln_L1=(-8(2)10)) predict(nu0)
*marginsplot

*quietly margins, at(diversity_ln_L1=(-8 -6 -4 -2 0 2) absorptive_capacity_L1=(0 0.5 1 )) predict(nu0)
*marginsplot, xdimension(at(diversity_ln_L1))
